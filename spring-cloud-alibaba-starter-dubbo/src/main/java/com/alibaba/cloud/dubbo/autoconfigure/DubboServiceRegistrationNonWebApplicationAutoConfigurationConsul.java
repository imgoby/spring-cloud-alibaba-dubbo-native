...
public class DubboServiceRegistrationNonWebApplicationAutoConfigurationConsul {
	...
	private void setServerPort() {
		if (serverPort == null) {
			synchronized (DubboServiceRegistrationNonWebApplicationAutoConfigurationConsul.class) {
				if (serverPort == null) {
