...
public class DubboServiceRegistrationNonWebApplicationAutoConfigurationZookeeper {
	...
	private void setServerPort() {
		if (serverPort == null) {
			synchronized (DubboServiceRegistrationNonWebApplicationAutoConfigurationZookeeper.class) {
				if (serverPort == null) {
