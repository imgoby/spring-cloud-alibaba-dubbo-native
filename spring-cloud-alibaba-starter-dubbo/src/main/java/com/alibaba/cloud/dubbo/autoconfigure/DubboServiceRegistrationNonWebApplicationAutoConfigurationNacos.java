...
public class DubboServiceRegistrationNonWebApplicationAutoConfigurationNacos {
	...
	private void setServerPort() {
		if (serverPort == null) {
			synchronized (DubboServiceRegistrationNonWebApplicationAutoConfigurationNacos.class) {
				if (serverPort == null) {
